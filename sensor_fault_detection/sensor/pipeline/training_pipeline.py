...
class TrainPipeline:
    ...
    #Taking Input from DataIngestionArtifact  
    ...
    def start_model_trainer(self,data_transformation_artifact: DataTransformationArtifact):
        try:
            ...
            model_atifact = model_trainer.initiate_model_trainer()

            return model_atifact
    ...
    def start_model_pusher(self,model_eval_artifact:ModelEvaluationArtifact):
        try:
            ...
            model_pusher_artifact = model_pusher.initiate_modelpusher()
    ...
    def run_pipeline(self):
        try:
            #giving output from start_dataingestion()  
