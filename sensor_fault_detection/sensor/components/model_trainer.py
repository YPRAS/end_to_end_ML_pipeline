...
class ModelTrainer: 
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            print("model_trainer_config expected_accuracy",self.model_trainer_config.expected_accuracy)
            ...
            if diff>self.model_trainer_config.overfitting_underfitting_threshold:
                raise Exception("Model is not good try to do make it better ")
